...
//    int nvlist_add_boolean_value(nvlist_t list, const char *, boolean_t);
//    int nvlist_add_byte(nvlist_t list, const char *, uchar_t);
//    int nvlist_add_int8(nvlist_t list, const char *, int8_t);
//    int nvlist_add_uint8(nvlist_t list, const char *, uint8_t);
//    int nvlist_add_int16(nvlist_t list, const char *, int16_t);
//    int nvlist_add_uint16(nvlist_t list, const char *, uint16_t);
//    int nvlist_add_int32(nvlist_t list, const char *, int32_t);
//    int nvlist_add_uint32(nvlist_t list, const char *, uint32_t);
//    int nvlist_add_int64(nvlist_t list, const char *, int64_t);
//    int nvlist_add_uint64(nvlist_t list, const char *, uint64_t);
    int nvlist_add_string(nvlist_t list, String key, String value);
//    int nvlist_add_nvlist(nvlist_t list, const char *, nvlist_t list);
//    int nvlist_add_boolean_array(nvlist_t list, const char *, boolean_t *, uint_t);
//    int nvlist_add_byte_array(nvlist_t list, const char *, uchar_t *, uint_t);
//    int nvlist_add_int8_array(nvlist_t list, const char *, int8_t *, uint_t);
//    int nvlist_add_uint8_array(nvlist_t list, const char *, uint8_t *, uint_t);
//    int nvlist_add_int16_array(nvlist_t list, const char *, int16_t *, uint_t);
//    int nvlist_add_uint16_array(nvlist_t list, const char *, uint16_t *, uint_t);
//    int nvlist_add_int32_array(nvlist_t list, const char *, int32_t *, uint_t);
//    int nvlist_add_uint32_array(nvlist_t list, const char *, uint32_t *, uint_t);
//    int nvlist_add_int64_array(nvlist_t list, const char *, int64_t *, uint_t);
//    int nvlist_add_uint64_array(nvlist_t list, const char *, uint64_t *, uint_t);
//    int nvlist_add_string_array(nvlist_t list, const char *, char *const *, uint_t);
//    int nvlist_add_nvlist_array(nvlist_t list, const char *, nvlist_t list*, uint_t);
//    int nvlist_add_hrtime(nvlist_t list, const char *, hrtime_t);
//
//    int nvlist_remove(nvlist_t list, const char *, data_type_t);
//    int nvlist_remove_all(nvlist_t list, const char *);
//
//    int nvlist_lookup_boolean(nvlist_t list, const char *);
//    int nvlist_lookup_boolean_value(nvlist_t list, const char *, boolean_t *);
//    int nvlist_lookup_byte(nvlist_t list, const char *, uchar_t *);
//    int nvlist_lookup_int8(nvlist_t list, const char *, int8_t *);
//    int nvlist_lookup_uint8(nvlist_t list, const char *, uint8_t *);
//    int nvlist_lookup_int16(nvlist_t list, const char *, int16_t *);
//    int nvlist_lookup_uint16(nvlist_t list, const char *, uint16_t *);
//    int nvlist_lookup_int32(nvlist_t list, const char *, int32_t *);
//    int nvlist_lookup_uint32(nvlist_t list, const char *, uint32_t *);
//    int nvlist_lookup_int64(nvlist_t list, const char *, int64_t *);
//    int nvlist_lookup_uint64(nvlist_t list, const char *, uint64_t *);
//    int nvlist_lookup_string(nvlist_t list, const char *, char **);
//    int nvlist_lookup_nvlist(nvlist_t list, const char *, nvlist_t list*);
//    int nvlist_lookup_boolean_array(nvlist_t list, const char *,
//        boolean_t **, uint_t *);
//    int nvlist_lookup_byte_array(nvlist_t list, const char *, uchar_t **, uint_t *);
//    int nvlist_lookup_int8_array(nvlist_t list, const char *, int8_t **, uint_t *);
//    int nvlist_lookup_uint8_array(nvlist_t list, const char *, uint8_t **, uint_t *);
//    int nvlist_lookup_int16_array(nvlist_t list, const char *, int16_t **, uint_t *);
//    int nvlist_lookup_uint16_array(nvlist_t list, const char *, uint16_t **, uint_t *);
//    int nvlist_lookup_int32_array(nvlist_t list, const char *, int32_t **, uint_t *);
//    int nvlist_lookup_uint32_array(nvlist_t list, const char *, uint32_t **, uint_t *);
//    int nvlist_lookup_int64_array(nvlist_t list, const char *, int64_t **, uint_t *);
//    int nvlist_lookup_uint64_array(nvlist_t list, const char *, uint64_t **, uint_t *);
//    int nvlist_lookup_string_array(nvlist_t list, const char *, char ***, uint_t *);
//    int nvlist_lookup_nvlist_array(nvlist_t list, const char *,
//        nvlist_t list**, uint_t *);
//    int nvlist_lookup_hrtime(nvlist_t list, const char *, hrtime_t *);
//    int nvlist_lookup_pairs(nvlist_t listnvl, int, ...);
//
//    int nvlist_lookup_nvpair(nvlist_t listnvl, const char *, nvpair_t **);
